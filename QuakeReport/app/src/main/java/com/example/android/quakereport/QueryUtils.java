...
public final class QueryUtils {
     ...
     */
    public static ArrayList<EarthquakeRecord> extractEarthquakes() {
        ArrayList<EarthquakeRecord> earthquakes = new ArrayList<>();
